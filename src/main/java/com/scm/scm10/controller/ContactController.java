    ...
    public String searchHandler(
        ...
        if (contactSearchForm.getField() != null && contactSearchForm.getValue() != null) {
            switch (contactSearchForm.getField().toLowerCase()) {
                case "name":
                    pageContact = contactService.searchByName(contactSearchForm.getValue(), size, page, sortBy,
                            direction, user);
                    break;
                case "email":
                    pageContact = contactService.searchByEmail(contactSearchForm.getValue(), size, page, sortBy,
                            direction, user);
                    break;
                case "phone":
